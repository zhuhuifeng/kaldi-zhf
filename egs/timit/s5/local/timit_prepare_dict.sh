...
# add the file check zhuhuifeng@20170603
...
[ -f $dir/silence_phones.txt ] && [ -f $dir/optional_silence.txt ] && [ -f $dir/lexicon.txt ] && [ $dir/extra_questions.txt ] && [ -f $lmdir/lm_phone_bg.arpa.gz ] && echo "skip preparing for dict and language model" && exit 0
