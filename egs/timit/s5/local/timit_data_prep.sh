...
for x in train dev test; do
	...
	# check the main result files whether have been generated
	[ -f ${x}_wav.scp ] && [ -f ${x}.text ] && [ -f $x.utt2spk ] && [ -f $x.spk2utt ] && [ -f ${x}_dur.ark ] && echo "skip processing '$x' data" && continue
  ...
  wav-to-duration scp:${x}_wav.scp ark,t:${x}_dur.ark
